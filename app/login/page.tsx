...
export default function Login() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-violet-900 via-purple-900 to-black flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-800">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">
              Welcome to <span className="text-orange-500">ScribbleSense</span>
            </h1>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <Link href="/register" className="text-orange-500 hover:text-orange-400 font-medium transition-colors duration-300">
                Sign up here
              </Link>
            </p>
          </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-xs">Handwriting</p>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 text-xs">Multi-lingual</p>
          </div>
        </div>
      </div>
    </main>
