...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-1/4 top-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-15 lg:left-1/4 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-1/2">
